...
stressapptest_duration_sec=$((stressapptest_duration + 1))
...
# touch /data/strssapptest.log
# echo "" > /data/strssapptest.log
# echo "stressapptest测试开始"
# /data/stressapptest -s 10 -M 1000 >> /data/stresstestlog/strssapptest.log
# sleep 5
# /data/stressapptest -s 10 -M 1000 >> /data/stresstestlog/strssapptest.log
...
#echo "memster测试开始"
# nohup /data/memtester 550M 1 > /data/mem.log
#echo "memtester测试完成"
