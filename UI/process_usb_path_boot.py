...
class Log:
    with open("boot_usb_query_log.txt", "w") as f:
        f.close()

    def append_log(self, text):
        with open("boot_usb_query_log.txt", "a+") as f:
            f.write(str(text))
            f.write("\n")


class GetBootStoragePath:
    def __init__(self):
        self.device_name = ui_conf_file.get_option_value(ui_conf_file.section_ui_boot_check, ui_conf_file.ui_option_device_name)
        self.log = Log()
    ...
    def root_devices(self):
        ...
        cmd_raw = ui_conf_file.get_option_value(ui_conf_file.section_storage_stability,
    ...
    def get_storage_path_info(self):
        # self.root_devices()
        # system_type = ui_conf_file.get_option_value(ui_conf_file.section_storage_stability, ui_conf_file.ui_option_system_type)
...
if __name__ == '__main__':
    mem_ = GetBootStoragePath()
    mem_.get_storage_path_info()
    # mem_.root_devices()
