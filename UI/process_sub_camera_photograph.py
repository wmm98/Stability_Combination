...
class Photograph:
    ...
    def save_img(self):
        ...
        is_double = ui_conf_file.get_option_value(ui_conf_file.section_ui_boot_check,
        ...
        if int(is_double):
            ...
            x = ui_conf_file.get_option_value(ui_conf_file.section_ui_boot_check, ui_conf_file.option_switch_x_value)
            y = ui_conf_file.get_option_value(ui_conf_file.section_ui_boot_check, ui_conf_file.option_switch_y_value)
            # clear img in device
            self.remove_img()
            time.sleep(1)
